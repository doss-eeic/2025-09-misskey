...
const onlyOnOrOffNotificationTypes = ['app', 'achievementEarned', 'login', 'createToken', 'scheduledNotePosted', 'scheduledNotePostFailed', 'llmRequestSuccess', 'llmRequestFailed'] satisfies (typeof notificationTypes[number])[] as string[];
