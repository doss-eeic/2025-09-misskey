...
export type LlmGenNoteRequest = operations['llm___gen-note']['requestBody']['content']['application/json'];
export type LlmGenNoteResponse = operations['llm___gen-note']['responses']['200']['content']['application/json'];
export type LlmSuggestRequest = operations['llm___suggest']['requestBody']['content']['application/json'];
export type LlmSuggestResponse = operations['llm___suggest']['responses']['200']['content']['application/json'];
